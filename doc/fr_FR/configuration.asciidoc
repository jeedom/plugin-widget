...
IMPORTANT: Pour être sur d'éviter un conflit au niveau des IDs (qui peut planter toute la page web), sous Jeedom nous utilisons des class et des attribut "data-" cela permet d'etre sur qu'en cas de collision toute la page web ne soit pas plantée.
	permet 
