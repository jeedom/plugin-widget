...
\#name_display#::
Nom de la commande et vide si le nom de la commande ne doit pas être affiché.
+
----
A utiliser comme du texte ou en JS
----
...
+
----
A utiliser dans les attributs HTML style
----
...
\#valueName#::
Nom de la commande info liée, si la commande action est liée à une commande info, nom de la commande action sinon. Vide si le nom de la commande ne doit pas être affiché.
+
----
A utiliser comme du texte ou en JS
----
