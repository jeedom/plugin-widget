...
[NOTE]
===============================
Il vous faut au préalable créer un compte sur le market Jeedom (https://market.jeedom.fr) puis entrer vos informations de connexion (login et mdp) dans les paramètres de votre Jeedom ("Général"=>"Administration"=>"Configuration"=>"Market et mise à jours")
===============================
...
TIP: Plus il y a de commande historiser plus cela peut ralentir le système, il ne faut donc activer cette option que sur les commandes pour lesquelles vous avez une utilité d'avoir un historique.
...
==== Autres
#Doc à venir# (à completer par Loïc)
