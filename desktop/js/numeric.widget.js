        ...
        $(this).find('td').each(function (index) {
            ...
            switch (index) {
                case 0:
                    ...
                    $(this).find('select').attr('name', 'bsInfoNumericImage' + indexTrReal);
                    $(this).find('select').attr('data-index', indexTrReal);
                    $(this).find('select').attr('id', 'bsInfoNumericImage' + indexTrReal);
                    break;
                case 1:
                    ...
                    $(this).find('label').attr('id', 'bsInfoNumericLabel' + indexTrReal);
                    break;
                case 2:
                ...
                case 4:
                    ...
                    $(this).find('img').attr('id', 'bsInfoNumericPreview' + indexTrReal);
                    $(this).find('img').attr('alt', 'image ' + indexTrReal);
                    break;
                case 4:
...
$('#bsInfoNumericAddEntry').on('click', function () {
    ...
    html += '<select class="form-control widgetsView" value="" data-index="' + index + '" name="bsInfoNumericImage' + index + '" id="bsInfoNumericImage' + index + '">';
    html += '</select>';
    html += '</td>';
    html += '<td style="text-align: center; vertical-align: middle;">';
...
function getHtmlWidgetInfoNumeric(dashboard) {
    ...
    switch ($('#bsInfoNumericType').val()) {
        ...
        case "1":
            ...
            height = $('#bsInfoNumericPreview0').height();
            break;
    }
    if (dashboard) {
        switch ($('#bsInfoNumericType').val()) {
