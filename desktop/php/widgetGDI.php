...
<div id="bsHaloCreate" style="display: none; z-index: 1020; border-radius: 350px; background: transparent; width: 200px; height: 100px;"></div>
...
-->
        <form class="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="input-group bsHaloColor" name="bsHaloColor" id="bsHaloColor" ><input type="text" value="rgba(255,255,0,0.5)" class="form-control"/><span class="input-group-addon"><i></i></span></div>
