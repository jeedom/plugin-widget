...
class widget {
	...
	public static function getContainer() {
		...
		foreach ($widget_list as $widget) {
			...
			$return .= "<center>";
			$return .= '<img class="lazy" style="margin-left: 40px;border: 1px solid #C5C5C5;border-radius:5px; padding: 3px" src="plugins/widget/plugin_info/widget_icon.png" data-original3="' . $urlPath3 . '" data-original2="' . $urlPath2 . '" data-original="' . $urlPath . '" height="105" width="95" />';
			$return .= "</center>";
			if ($widget->getVersion() == 'mobile') {
